...
//	function index(){
//      //depreciation?
//      //remove these from other objects
//      $this->error("STOP!");
//      $this->view();
//    }
...
////            exit;
////          }
////          elseif ($this->is_auth($group='admin')){
...
//          
//    }
          //TO DO: set this to go admin->view->dash;
          

/////////////////////results
//		$this->_render_page('admin/dash', $this->data);
//        $this->load->view('templates/header');
//        //$this->load->view('auth/dash');
//        $this->load->view('templates/footer');
          //$this->load_page($group);
          
        
   //     else {//group not admin, but something else
...
//echo "not logged in.  are you partner?";
...
//die();
 ...
 //               $year %400 ? 28 : 29))) :(
 //                 ($month - 1) % 7 % 2 ? 30 :
 //                   31)); //returns days in the given month
          
          //else... group is not admin
//          if ($this->is_admin()){
//            redirect($group.'/view');//admin can go anywhere
//            exit;
//          }
//          elseif ($this->is_auth($group='hackers')){
//            redirect($group.'/view');//only if authorized
//            exit;
//          }
//            //http://davidwalsh.name/php-shorthand-if-else-ternary-operators
//          else{ 
...
//		  }
        ...
        //{
        //    //redirect('partner/dash', 'refresh');
        //    redirect($group.'/view');
        //}
		//}
//		if ($this->ion_auth->is_admin()) //is an admin
//		{
//          //TO DO: set this to go admin->view->dash;
//          
//			//set the flash data error message if there is one
...
//			}
//
//			$this->_render_page('auth/view', $this->data);
//		}
        //$this->load->view('templates/footer');
        //else {
//echo "FOUR";
...
//      if ($this->is_admin()){
//
////This is stuff only an admin should do.        	
//            $this->load->database();
//            $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
//			$this->data['users'] = $this->ion_auth->users()->result();
//			foreach ($this->data['users'] as $k => $user)
...
//      }
//  
//      //foreach($needle in ($this->get_users_groups(){
//      //  echo "<h1>.$needle.</h1>";  
//      //  }
//    }
    
    function get_users_groups(){
      return $this->ion_auth->get_users_groups();
    }
	  ...
	  if ($this->form_validation->run() == true)
		{
          ...
          if($this->logged_in())//true or false
          {
            ...
            if($this->is_auth($this->get_users_groups()))
            {
              //die ("you are authorized as a $group");
              $this->view($group."/home");
              exit;
            }
            else
            {
              ...
              //die ("you are not an authorized $group");
      ...
      else //not logged in
	    {
          ...
          //send username
            $this->data['identity'] = array('name' => 'identity',
				'id' => 'identity',
				'type' => 'text','value' => $this->form_validation->set_value('identity'),
			);
