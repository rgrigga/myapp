	  ...
	  if ($this->form_validation->run() == true)
		{
          ...
          else
          {
			...
			$this->session->set_flashdata('message', $this->ion_auth->errors());
			redirect(base_url().'home', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
		  }
        }
      else //not logged in
	    {
    ...
    function _render_page($view, $data=null, $render=false)
       {
          ...
          $view_html .=$this->load->view('templates/nav',$this->viewdata);
