	<nav class="navbar navbar-fixed-top navbar-inverse user-top" role="navigation">
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
			...
			@foreach ($company->menus() as $menu)
				<li {{ (Request::is('{{{strtolower($menu)}}}') ? ' class="active"' : '') }}><a href="{{{URL::to(strtolower($menu))}}}">{{{ucfirst($menu)}}}</a>
					</li>
					<!-- <li><a href="#{{strtolower($menu)}}"><i class="fa fa-link"></i></a></li> -->
			@endforeach
			</ul>
...
<!--           <ul class="nav navbar-nav">
	        ...
	        <ul class="nav navbar-nav navbar-right">
	            ...
	            @else
	                <li {{ (Request::is('user/login') ? ' class="active"' : '') }}><a class="dot bam" href="{{{ URL::to('user/login') }}}">Login</a></li>
