...
?>      
      <div class="page-header">
        ...
        <p class="lead">AKA How to Hack a Password 'secured' with recursive md5() algorithm</h1>
        <p>Type any real or fake password here, or type a url in the browser, just like this:</p>
        <?php $str= URL::to('/md5').'?q='.$o ?>
        <p><code><?= $str ?></code></p>
...
<h1>BAM</h1>
<p>since most of your users probably use the same password for their email, gmail, facebook, and twitter accounts...</p>
