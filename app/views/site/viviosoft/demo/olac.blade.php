...
<html lang="en">
  <head>
    ...
    <title>Viviosoft: OLAC Demo</title>

    <!-- Bootstrap core CSS -->
    <!-- <link href="/assets/dist/css/bootstrap.min.css" rel="stylesheet"> -->

    <!-- LESS stylesheet -->
    <link rel="stylesheet/less" type="text/css" href="/assets/css/less/olac.less" />
    ...
    <div class="navbar navbar-fixed-top navbar-inverse user-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">OLAC Demo</a>
        </div>
...
<!--           <p class="pull-left visible-xs">
          ...
          <div class="alert alert-danger"><strong>UPDATE</strong> The left-nav is now "fixed to top".  Try it out!.</div>
          <div class="jumbotron">
            <!-- <div class="bam">:)</div> -->
            <h1>OLAC Demo</h1>
...
<span class="moved">MOVED TO LESS</span>
...
'}}}
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-lg-4">
              <h2>Hiding the address bar</h2>
              <p>This page now uses some additional javascript to "hide" the address bar on small devices.</p>
              
              <p><a class="btn btn-default" href="http://menacingcloud.com/?c=iPhoneAddressBar">View details &raquo;</a></p>
            </div><!--/span-->
            <div class="col-6 col-sm-6 col-lg-4">
              <h2>Toggling Chevrons!</h2>
              <p><pre>{{{"$('.dropdown-toggle').on('click', function(){
  $(this).find('i').toggleClass('icon-cevron-left icon-chevron-down');
});"}}}</pre></p>
              <p>
...
<ul class="nav">
                ...
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                  Dropdown <i class="icon-chevron-left"></i>
                </a>
