...
namespace  {
 class View extends Illuminate\Support\Facades\View{
	 ...
	 * @return \Robbo\Presenter\View\Illuminate\View\View 
	 * @static 
	 */
...
namespace  {
 class Confide extends Zizaco\Confide\ConfideFacade{
	 ...
	 *
	 * @param \Zizaco\Confide\ConfideRepository $repo A "repository" to abstract all the database interaction.
	 * @return void 
	 * @static 
	 */
	 public static function __construct($repo){
		 static::$root->__construct($repo);
	 }
	 ...
	 */
	 public static function logAttempt($credentials, $confirmed_only = false, $identity_columns = array()){
		return static::$root->logAttempt($credentials, $confirmed_only, $identity_columns);
	 }
	 ...
	 */
	 public static function isValidToken($token){
		return static::$root->isValidToken($token);
	 }
...
namespace  {
 class Entrust extends Zizaco\Entrust\EntrustFacade{
	 ...
	 * Create a new confide instance.
	 *
	 * @param \Zizaco\Entrust\Illuminate\Foundation\Application $app 
	 * @return void 
	 * @static 
	 */
	 public static function __construct($app){
...
namespace  {
 class Presentable{
	 ...
	 *
	 * @return \Robbo\Presenter\Robbo\Presenter\Presenter 
	 * @static 
	 */
...
namespace  {
 class Basset extends Basset\Facade{
	 ...
	 * @static 
	 */
	 public static function __construct($log, $assetFactory, $filterFactory, $finder){
		 static::$root->__construct($log, $assetFactory, $filterFactory, $finder);
	 }
	 ...
	 */
	 public static function collections($collections){
		 static::$root->collections($collections);
	 }
...
namespace  {
 class Carbon{
	 ...
	 * @static 
	 */
	 public static function __construct($time = null, $tz = null){
		 static::$root->__construct($time, $tz);
	 }
	 ...
	 */
	 public static function create($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null){
		 static::$root->create($year, $month, $day, $hour, $minute, $second, $tz);
	 }
	 ...
	 */
	 public static function createFromDate($year = null, $month = null, $day = null, $tz = null){
		 static::$root->createFromDate($year, $month, $day, $tz);
	 }
	 ...
	 */
	 public static function createFromTime($hour = null, $minute = null, $second = null, $tz = null){
		 static::$root->createFromTime($hour, $minute, $second, $tz);
	 }
	 ...
	 */
	 public static function createFromFormat($format, $time, $object = null){
		 static::$root->createFromFormat($format, $time, $object);
	 }
	 ...
	 */
	 public static function createFromTimestamp($timestamp, $tz = null){
		 static::$root->createFromTimestamp($timestamp, $tz);
	 }
	 ...
	 */
	 public static function createFromTimestampUTC($timestamp){
		 static::$root->createFromTimestampUTC($timestamp);
	 }
	 ...
	 */
	 public static function setDate($year, $month, $day){
		 static::$root->setDate($year, $month, $day);
	 }
	 ...
	 * @static 
	 */
	 public static function setTime($hour, $minute, $second = 0){
		 static::$root->setTime($hour, $minute, $second);
	 }
	 ...
	 * @static 
	 */
	 public static function setDateTime($year, $month, $day, $hour, $minute, $second){
		 static::$root->setDateTime($year, $month, $day, $hour, $minute, $second);
	 }
	 ...
	 */
	 public static function toFormattedDateString(){
		 static::$root->toFormattedDateString();
	 }
	 ...
	 */
	 public static function toDayDateTimeString(){
		 static::$root->toDayDateTimeString();
	 }
	 ...
	 */
	 public static function diffInYears($dt = null, $abs = true){
		 static::$root->diffInYears($dt, $abs);
	 }
	 ...
	 */
	 public static function diffInMonths($dt = null, $abs = true){
		 static::$root->diffInMonths($dt, $abs);
	 }
	 ...
	 */
	 public static function diffInHours($dt = null, $abs = true){
		 static::$root->diffInHours($dt, $abs);
	 }
	 ...
	 */
	 public static function diffInMinutes($dt = null, $abs = true){
		 static::$root->diffInMinutes($dt, $abs);
	 }
	 ...
	 */
	 public static function diffInSeconds($dt = null, $abs = true){
		 static::$root->diffInSeconds($dt, $abs);
	 }
	 ...
	 * @static 
	 */
	 public static function diffForHumans($other = null){
		 static::$root->diffForHumans($other);
	 }
